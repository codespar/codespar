...
| Variable | Default | Description |
|----------|---------|-------------|
| `RESEND_API_KEY` | -- | Resend API key for sending newsletter welcome emails. If not set, subscriptions are stored but no emails are sent. Get one at [resend.com](https://resend.com). |
