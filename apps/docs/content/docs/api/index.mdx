...
|-------|-----------|-------------|
| [Agents](/docs/api/agents) | `GET /api/agents`, `GET /api/agents/:id`, `POST /api/agents`, `DELETE /api/agents/:id`, `POST /api/agents/:id/action`, `GET /api/agent-types` | Manage agent lifecycle, creation, and actions |
...
| [Scheduler](/docs/api/scheduler) | `GET /api/scheduler`, `POST /api/scheduler/:name/pause`, `POST /api/scheduler/:name/resume`, `DELETE /api/scheduler/:name` | Manage recurring scheduled tasks |
| [Newsletter](/docs/api/newsletter) | `POST /api/newsletter/subscribe`, `GET /api/newsletter/subscribers`, `DELETE /api/newsletter/unsubscribe`, `GET /api/newsletter/count` | Newsletter subscriber management |
...
- [Scheduler API](/docs/api/scheduler) -- Recurring tasks
- [Newsletter API](/docs/api/newsletter) -- Subscriber management
